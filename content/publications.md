...
- <span class="pub-badge q2">Q2</span> **Acoustic Signal-Based Smart Attendance System for Preventing Fraudulent Attendees**  
   Yeonwoo Sea, Jihwan Park, Yunji Ha, Sihyung Lee, Jiyeon Lee  
   *IEEE Access*, Vol. 14, pp. 51374-51390, April 2026.

### 2025 and Earlier

- <span class="pub-badge q2">Q2</span> **DRL-assisted task offloading in enhanced time-expanded graph (eTEG)-modeled aerial computing**  
...
- **A Robust Decryption Technique Using Letter Frequency Analysis for Short Monoalphabetic Substitution Ciphers**  
   Dayeong Kang, Jiyeon Lee  
   *Journal of Computing Science and Engineering*, Vol. 18, No. 3, pp. 144-151, September 2024.
...
- <span class="pub-badge q1">Q1</span> **Data-Similarity-based IoT Node Selection for UAV Trajectory Optimization**  
...
- <span class="pub-badge q1">Q1</span> **VRKeyLogger: Virtual Keystroke Inference Attack via Eavesdropping Controller Usage Pattern in WebVR**  
   Jiyeon Lee, Hyosu Kim, Kilho Lee  
...
- **Exploiting Missing Value Patterns for a Backdoor Attack on Machine Learning Models of Electronic Health Records: Development and Validation Study**  
   Byunggill Joe, Yonghyeon Park (co-first), Jihun Hamm, Insik Shin, Jiyeon Lee  
   *JMIR Medical Informatics*, Vol. 10, No. 8, August 2022.

- <span class="pub-badge bkcs">BKCS</span> **AdCube: WebVR Ad Fraud and Practical Confinement of Third-Party Ads**  
   Hyunjoo Lee, Jiyeon Lee (co-first), Daejun Kim, Suman Jana, Insik Shin, Sooel Son  
...
- <span class="pub-badge bkcs">BKCS</span> **Pride and Prejudice in Progressive Web Apps: Abusing Native App-like Features in Web Applications**  
    Jiyeon Lee, Hayeon Kim, Junghwan Park, Insik Shin, Sooel Son  
    *Proceedings of the 25th ACM Conference on Computer and Communications Security (CCS)*, Toronto, Canada, October 2018.

- <span class="pub-badge q1">Q1</span> **Global EDF Schedulability Analysis for Parallel Tasks on Multi-core Platforms**  
    Hoon Sung Chwa, Jinkyu Lee, Jiyeon Lee, Kieu-My Phan, Arvind Easwaran, Insik Shin  
    *IEEE Transactions on Parallel & Distributed Systems (TPDS)*, Vol. 28, No. 5, pp. 1331-1345, May 2017.

- <span class="pub-badge q2">Q2</span> **Thread-level Priority Assignment in Global Multiprocessor Scheduling for DAG Tasks**  
    Jiyeon Lee, Hoon Sung Chwa, Jinkyu Lee, Insik Shin  
    *Journal of Systems and Software (JSS)*, Vol. 113, pp. 246-256, March 2016.

- <span class="pub-badge bkcs">BKCS</span> <span class="pub-badge runner-up">Best Paper Runner-up</span> **MC-Fluid: Fluid Model-based Mixed-Criticality Scheduling on Multiprocessors**  
...
- **A Study on the Development and Application of an Integrated External Risk Assessment System Specialized for the Financial Domain**  
   ...
   *Proceedings of KIIT Conference*, June 2026.

- <span class="pub-badge award">Best Paper Award</span> **Impact of Prompt Engineering on Security Report Quality : An Empirical Study with AXCEL & G-evaluation**  
   Yujun Kim, Useong Gwon, Seungsoo Oh, Seunghyun Kwak, Yunseong Moon, Yeonhak Kim, Jiyeon Lee  
   *Proceedings of KIIT Conference*, November 2025.

- **Backdoor Attacks on Generative Language Models in Disaster Situations: Attack Scenarios and Empirical Analysis**  
   Jongyoung Kang, Jiyeon Lee  
   *The Transactions of the Korea Information Processing Society*, Vol. 14, No. 7, pp. 533-541, July 2025.
...
- **Metadata-based Backdoor Attack on Medical Neural Networks**  
   Yonghyeon Park, Byunggill Joe, Jiyeon Lee, Minwoo Jeong, Insik Shin  
...
- <span class="pub-badge award">Best Paper Award</span> **GPGPU Parallelization Techniques for Redundancy Elimination Algorithm**  
   ...
   *Korean Institute of Information Scientists and Engineers*, Pyeongchang, South Korea, December 2014.

- **GPU-SPARC: Accelerating Parallelism in Multi-GPU Real-Time Systems**  
    Wookhyun Han, Hwidong Bae, Hyosu Kim, Jiyeon Lee, Insik Shin  
...
- **A Survey on Real-time Support for Mixed-criticality Cyber-Physical Systems**  
    Jaewoo Lee, Jiyeon Lee, Insik Shin  
    *Korea Information Science Society*, Vol. 31, No. 12, December 2013.

- <span class="pub-badge award">Best Paper Award</span> **Optimal Priority Assignment for Parallel Tasks under Fixed Priority Scheduling in Realtime Systems**  
    Jiyeon Lee, Hoon Sung Chwa, Insik Shin  
    *Korean Institute of Information Scientists and Engineers*, Jeju, South Korea, November 2013.
